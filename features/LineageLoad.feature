Feature: Load Data Lineage using API
  ...
  Scenario: Get a list of nodes with a contains relation
    Given following lineage data has been already loaded:
      | File        | Id  | Name                  | Type           | Description                        | Select Hidden | Id Source | Id Target |
      | Resources   | 1   | First Field           | Field          | This is First calculated field     | False         |           |           |
      | Resources   | 2   | Second Field          | Field          | This is Second calculated field    |               |           |           |
      | Groups      | 11  | First Transformation  | System         | This is the first transformation   | False         |           |           |
      | Groups      | 12  | Second Transformation | System         | This is the second transformation  | False         |           |           |
      | Groups      | 101 | First Group           | System         | Our first group in simple example  | False         |           |           |
      | Groups      | 102 | Second Group          | System         | Our second group in simple example | False         |           |           |
      | Relations   |     |                       | CONTAINS       |                                    |               | 101       | 1         |
      | Relations   |     |                       | CONTAINS       |                                    |               | 101       | 11        |
  ...
  Scenario: Delete query
    Given following lineage data has been already loaded:
      ...
      | Relations   |     |                       | DEPENDS        |                                    |               | 2         | 11        |
      | Relations   |     |                       | DEPENDS        |                                    |               | 11        | 1         |
    When "app-admin" tries to delete a node with ID "101"
    Then "app-admin" tries to list top Groups and he receives following nodes list:
      | Id  | Name                  | Type           | Description                        |
      | 102 | Second Group          | System         | Our second group in simple example |
